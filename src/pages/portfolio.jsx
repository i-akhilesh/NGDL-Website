      ...
      <section className="mil-p-120-120">
        <div className="container">
          <div className="row justify-content-between align-items-center">
            ...
            <div className="col-xl-5 mil-mb-60">
              <span className="mil-suptitle mil-suptitle-2 mil-mb-30">
                Digitizing Documentation System.
              </span>
              <h3 className="mil-mb-30">
                A cloud-based Document Control Software
              </h3>
          ...
          <div className="row flex-sm-row-reverse justify-content-between align-items-center">
            ...
            <div className="col-xl-5 mil-mb-60">
              <span className="mil-suptitle mil-suptitle-2 mil-mb-30">
                IoT-Based Cold Storage Monitoring.
              </span>
              <h3 className="mil-mb-30">
                Smart Fridge Thermostat
              </h3>
              <Link href="project2" className="mil-button-with-label">
                <div className="mil-button mil-border mil-icon-button">
                  <span>
                    <i className="fas fa-plus" />
                  </span>
          ...
          <div className="row justify-content-between align-items-center">
            ...
            <div className="col-xl-5 mil-mb-60">
              <span className="mil-suptitle mil-suptitle-2 mil-mb-30">
                Synchronized Clock System for Labs
              </span>
              <h3 className="mil-mb-30">
                WiFi-based synchronized clock network with integrated temperature and humidity
              </h3>
              <Link href="project3" className="mil-button-with-label">
                <div className="mil-button mil-border mil-icon-button">
                  <span>
                    <i className="fas fa-plus" />
                  </span>
          ...
          {/* <div className="row flex-sm-row-reverse justify-content-between align-items-center">
            ...
            <div className="col-xl-5 mil-mb-60">
              <span className="mil-suptitle mil-suptitle-2 mil-mb-30">
                Soil & Water Quality Monitoring Kit
              </span>
              <h3 className="mil-mb-30">
